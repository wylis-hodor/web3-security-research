...
```
^ could be medium because user could limit how much they approve
...
### [M-2] Rebase, fee-on-tranfer, and ERC-777 tokens break protocol invariant (weird ERC20s)
Too many tokens sent out.

https://github.com/ConsenSysDiligence/Uniswap-audit-report-2018-12?tab=readme-ov-file#31-liquidity-pool-can-be-stolen-in-some-tokens-eg-erc-777-29
